...
public class ClientPlayNetHandler implements IClientPlayNetHandler {
    ...
    public void handlePlayerPosLook(SPlayerPositionLookPacket packetIn) {
        ...
        NoRotate noRotate = FunctionRegistry.getNoRotate();


        if (noRotate.isState()) {
            noRotate.sendRotationPacket(f, f1);
    ...
    public void onDisconnect(ITextComponent reason) {
        ...
        if (this.guiScreenServer != null) {
            ...
            this.client.displayGuiScreen(
                    new DisconnectedScreen(new MultiplayerScreen(selfDestruct.unhooked ? new MainMenuScreen() : new MainMenuScreen()), field_243491_b, reason));
        }
    }
