...
public class MainMenuScreen extends Screen {
    ...
    protected void init() {
        ...
        this.
                addButton(new Button(this.width / 2 + 2 - 50, j + 72 + 42, 98, 20, new TranslationTextComponent("Accounts"), (p_lambda$init$2_1_) ->

                {
                    this.minecraft.displayGuiScreen(Vredux.getInstance().getAltManager());
                }));
        this.
