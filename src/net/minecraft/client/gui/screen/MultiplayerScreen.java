...
public class MultiplayerScreen extends Screen {
    ...
    private final VersionSelectScreen viaScreen = Vredux.getInstance().getViaMCP().getViaScreen();
    ...
    protected void init() {
        ...
        if (!selfDestruct.unhooked)
            addButton(Vredux.getInstance().getViaMCP().viaScreen);
    ...
    public void tick() {
        super.tick();
        Vredux.getInstance().getViaMCP().viaScreen.tick();
