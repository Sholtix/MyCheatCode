...
import wtf.sqwezz.events.EventLivingUpdate;
...
public abstract class PlayerEntity extends LivingEntity {
    ...
    public void tick() {
        ...
        Vredux.getInstance().getEventBus().post(livingUpdate);
    ...
    public boolean func_234569_d_(BlockState p_234569_1_) {
        AutoTool autoTool = Vredux.getInstance().getFunctionRegistry().getAutoTool();
        return !p_234569_1_.getRequiresTool() || (autoTool.isState() && autoTool.silent.get() && autoTool.itemIndex != -1
                ? inventory.getStackInSlot(autoTool.itemIndex).canHarvestBlock(p_234569_1_) : inventory.getCurrentItem().canHarvestBlock(p_234569_1_));
    }
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (flag5) {
                        if (i > 0) {
                            ...
                            boolean keepSprintState = autoSprint.isState() && autoSprint.saveSprint.get()
