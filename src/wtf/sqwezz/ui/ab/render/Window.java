package wtf.sqwezz.ui.ab.render;

import com.mojang.blaze3d.matrix.MatrixStack;
import com.mojang.blaze3d.platform.GlStateManager;
import wtf.sqwezz.ui.ab.donate.DonateItems;
...
public class Window extends Screen implements IMinecraft {
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if (MathUtil.isInRegion((float) mouseX, (float) mouseY, addingPanelX, addingPanelY, addingPanelWidth, addingPanelHeight) && button == 0) {
    ...
    private void renderAddingPanel(MatrixStack matrixStack, float x, float y, float width, float height, int mouseX, int mouseY) {
        boolean hovered = MathUtil.isInRegion(mouseX, mouseY, x, y, width, height);
