...
import wtf.sqwezz.ui.ab.render.impl.item.EditComponent;
...
public class AllItemComponent extends Component {
    ...
    public void render(MatrixStack stack, int mouseX, int mouseY) {
        ...
        for (Item item : Registry.ITEM) {
            ...
            if (MathUtil.isInRegion(x + 2 + currentX, y + currentY, x, y - 20, width, height + 20)) {
    ...
    public void mouseScrolled(double mouseX, double mouseY, double delta) {
        if (MathUtil.isInRegion((float) mouseX, (float) mouseY, x, y - 20, width, height + 20)) {
            scroll += delta * 10;
        }
        if (component != null)
    ...
    public void mouseClicked(double mouseX, double mouseY, int mouseButton) {
        ...
        for (Item item : Registry.ITEM) {
            ...
            if (MathUtil.isInRegion(x + 2 + currentX, y + currentY, x, y - 20, width, height + 20)) {
                ...
                if (MathUtil.isInRegion((float) mouseX, (float) mouseY, (int) (x + 2 + currentX), (int) (y + currentY), 16, 16)) {
