package wtf.sqwezz.ui.ab.render.impl.item;

import com.mojang.blaze3d.matrix.MatrixStack;
import wtf.sqwezz.Vredux;
import wtf.sqwezz.ui.ab.model.IItem;
import wtf.sqwezz.ui.ab.model.ItemImpl;
import wtf.sqwezz.ui.ab.render.impl.AddedItemComponent;
import wtf.sqwezz.ui.ab.render.impl.AllItemComponent;
import wtf.sqwezz.ui.ab.render.impl.Component;
import wtf.sqwezz.utils.client.IMinecraft;
import wtf.sqwezz.utils.components.ButtonComponent;
import wtf.sqwezz.utils.components.FieldComponent;
import wtf.sqwezz.utils.components.SliderComponent;
...
public class EditComponent extends Component implements IMinecraft {
    ...
    private final ButtonComponent add = new ButtonComponent(0, 0, 0, 0, "Добавить", () -> {
        if (!price.get().isEmpty()) {
            ...
            Vredux.getInstance().getItemStorage().addItem(stack.getItem(), Integer.parseInt(price.get()), Integer.parseInt(count.fieldComponent.get()), Integer.parseInt(damage.fieldComponent.get()), enchantmentWidget.get());
