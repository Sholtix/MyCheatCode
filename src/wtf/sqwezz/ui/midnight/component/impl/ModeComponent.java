    ...
    public void drawComponent(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        if (opened) {
            ...
            for (String s : option.strings) {
                ...
                Fonts.gilroy[14].drawString(matrixStack, s, x + 9 + animation.get(s), y + off + 23.5F + i, option.get().equals(s) ? style.getFirstColor().getRGB() : new Color(163, 176, 188).getRGB());
                i += 9;
            }
            height += 3;
        }
