package wtf.sqwezz.utils.render.font;

public class Fonts {

    public static Font montserrat, consolas, icons, damage, sfui, sfbold, sfMedium, icons2;
    ...
    public static void register() {
        ...
        icons2 = new Font("icons2.ttf.png", "icons2.ttf.json");
