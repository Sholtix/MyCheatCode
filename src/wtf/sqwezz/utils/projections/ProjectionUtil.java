package wtf.sqwezz.utils.projections;
...
public class ProjectionUtil implements IMinecraft {
    ...
    public static Vector3d getEntityPos(Entity entity, float partialTicks) {
        return new Vector3d(
                MathUtil.interpolate(entity.getPosX(), entity.lastTickPosX, partialTicks),
                MathUtil.interpolate(entity.getPosY(), entity.lastTickPosY, partialTicks),
                MathUtil.interpolate(entity.getPosZ(), entity.lastTickPosZ, partialTicks));
    }
