...
import wtf.sqwezz.utils.shader.exception.UndefinedShader;
...
public class ShaderUtil implements IMinecraft {
    ...
    public static ShaderUtil gradientRound = new ShaderUtil("gradientRound");
    ...
    public ShaderUtil(String fragmentShaderLoc) {
        ...
        try {
            ...
            int fragmentShaderID = switch (fragmentShaderLoc) {
                ...
                case "gradientRound" -> createShader(Shaders.getInstance().getGradientRound(), GL_FRAGMENT_SHADER);
