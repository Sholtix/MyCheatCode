package wtf.sqwezz.command.friends;

import wtf.sqwezz.utils.AESCrypt;
...
public class FriendStorage implements IMinecraft {
    ...
    private final File file = new File(mc.gameDir, separator + "Neverlose" + separator + "files" + separator + "friends.cfg");
